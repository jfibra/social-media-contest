  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4">
        <Card>
          <CardHeader className="bg-gradient-to-r from-realty-secondary to-realty-primary text-white">
          ...
          <CardContent className="pt-6">
            ...
            <div className="flex justify-between mt-8">
              ...
              <Button
                type="button"
                className="bg-realty-secondary hover:bg-realty-secondary/90 gap-2"
